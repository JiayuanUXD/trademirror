...
const CREATE_TABLES = [
  ...
  `CREATE TABLE IF NOT EXISTS monthly_portraits (
    ...
    key_trades TEXT NOT NULL DEFAULT '{}',
    created_at INTEGER NOT NULL,
    completed_at INTEGER,
    user_id TEXT NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS settings (
    ...
    daily_open_limit INTEGER NOT NULL DEFAULT 2,
    cap_ice REAL NOT NULL DEFAULT 0.20,
    cap_repair REAL NOT NULL DEFAULT 0.50,
    cap_ferment REAL NOT NULL DEFAULT 0.80,
    cap_main_rise REAL NOT NULL DEFAULT 1.00,
    cap_ebb REAL NOT NULL DEFAULT 0.30,
    thr_main_rise_limit_up INTEGER NOT NULL DEFAULT 80,
    thr_main_rise_seal_rate REAL NOT NULL DEFAULT 0.70,
    thr_main_rise_max_boards INTEGER NOT NULL DEFAULT 5,
    thr_ebb_limit_down INTEGER NOT NULL DEFAULT 30,
    thr_ice_limit_up INTEGER NOT NULL DEFAULT 30,
    thr_ice_max_boards INTEGER NOT NULL DEFAULT 2,
    thr_ferment_limit_up INTEGER NOT NULL DEFAULT 50,
    thr_ferment_max_boards INTEGER NOT NULL DEFAULT 4,
    min_turnover_yi REAL NOT NULL DEFAULT 1.0,
    min_turnover_rate_pct REAL NOT NULL DEFAULT 3.0,
    max_turnover_rate_pct REAL NOT NULL DEFAULT 25.0,
    min_price REAL NOT NULL DEFAULT 3,
    max_price REAL NOT NULL DEFAULT 200,
    exclude_st INTEGER NOT NULL DEFAULT 1,
    exclude_new INTEGER NOT NULL DEFAULT 1,
    max_pool_size INTEGER NOT NULL DEFAULT 8,
    user_id TEXT NOT NULL
  )`,
  `CREATE TABLE IF NOT EXISTS market_sentiment_daily (
    ...
    seal_rate REAL,
    max_consec_boards INTEGER,
    turnover_yi REAL,
    prev_limit_premium REAL,
    raw_payload TEXT,
    created_at INTEGER NOT NULL
  )`,
  `CREATE TABLE IF NOT EXISTS daily_market_state (
    trade_date TEXT PRIMARY KEY,
    stage TEXT NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS screener_pool_snapshot (
    id TEXT PRIMARY KEY,
    user_id TEXT NOT NULL,
    trade_date TEXT NOT NULL,
    ...
    gate_max_size INTEGER NOT NULL,
    pool_size INTEGER NOT NULL,
    universe_size INTEGER NOT NULL,
    filtered_summary TEXT NOT NULL DEFAULT '{}',
    created_at INTEGER NOT NULL
  )`,
...
const CREATE_INDEXES = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_market_state_date ON daily_market_state(trade_date DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_market_sentiment_date ON market_sentiment_daily(trade_date DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_guardrail_user_created ON guardrail_events(user_id, created_at DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_guardrail_decision ON guardrail_events(decision_ref)`,
  `CREATE INDEX IF NOT EXISTS idx_screener_snap_user_date ON screener_pool_snapshot(user_id, trade_date DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_screener_cand_snap ON screener_candidate(snapshot_id)`,
  `CREATE INDEX IF NOT EXISTS idx_screener_cand_user_created ON screener_candidate(user_id, created_at DESC)`,
];
...
const ALTER_TABLES: { table: string; column: string; def: string }[] = [
  ...
  { table: "settings", column: "daily_open_limit", def: "INTEGER NOT NULL DEFAULT 2" },
  { table: "settings", column: "cap_ice", def: "REAL NOT NULL DEFAULT 0.20" },
  { table: "settings", column: "cap_repair", def: "REAL NOT NULL DEFAULT 0.50" },
  { table: "settings", column: "cap_ferment", def: "REAL NOT NULL DEFAULT 0.80" },
  { table: "settings", column: "cap_main_rise", def: "REAL NOT NULL DEFAULT 1.00" },
  { table: "settings", column: "cap_ebb", def: "REAL NOT NULL DEFAULT 0.30" },
  { table: "settings", column: "min_turnover_yi", def: "REAL NOT NULL DEFAULT 1.0" },
  { table: "settings", column: "min_turnover_rate_pct", def: "REAL NOT NULL DEFAULT 3.0" },
  { table: "settings", column: "max_turnover_rate_pct", def: "REAL NOT NULL DEFAULT 25.0" },
  { table: "settings", column: "min_price", def: "REAL NOT NULL DEFAULT 3" },
  { table: "settings", column: "max_price", def: "REAL NOT NULL DEFAULT 200" },
  { table: "settings", column: "exclude_st", def: "INTEGER NOT NULL DEFAULT 1" },
  { table: "settings", column: "exclude_new", def: "INTEGER NOT NULL DEFAULT 1" },
  { table: "settings", column: "max_pool_size", def: "INTEGER NOT NULL DEFAULT 8" },
  { table: "settings", column: "thr_main_rise_limit_up", def: "INTEGER NOT NULL DEFAULT 80" },
  { table: "settings", column: "thr_main_rise_seal_rate", def: "REAL NOT NULL DEFAULT 0.70" },
  { table: "settings", column: "thr_main_rise_max_boards", def: "INTEGER NOT NULL DEFAULT 5" },
  { table: "settings", column: "thr_ebb_limit_down", def: "INTEGER NOT NULL DEFAULT 30" },
  { table: "settings", column: "thr_ice_limit_up", def: "INTEGER NOT NULL DEFAULT 30" },
  { table: "settings", column: "thr_ice_max_boards", def: "INTEGER NOT NULL DEFAULT 2" },
  { table: "settings", column: "thr_ferment_limit_up", def: "INTEGER NOT NULL DEFAULT 50" },
  { table: "settings", column: "thr_ferment_max_boards", def: "INTEGER NOT NULL DEFAULT 4" },
  { table: "monthly_portraits", column: "key_trades", def: "TEXT NOT NULL DEFAULT '{}'" },
];
